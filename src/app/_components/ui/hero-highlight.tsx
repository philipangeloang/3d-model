...
export const HeroHighlight = ({
  ...
  return (
    <div
      className={cn(
        "group relative flex h-[30rem] w-full items-center justify-center lg:h-[40rem]",
        containerClassName,
      )}
...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        `relative inline-block rounded-lg bg-gradient-to-r from-white to-white px-1 pb-1 dark:from-black dark:to-black`,
        className,
      )}
    >
      {children}
